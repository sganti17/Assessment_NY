  ...
  return function (Component$$1) {
    var WithUtils = function WithUtils(_ref, context) {
      var pickerRef = _ref.pickerRef,
          other = objectWithoutProperties$2(_ref, ['pickerRef']);
  ...
  createClass$2(ClockPointer, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement('div', { className: classnames(classes.thumb, defineProperty$5({}, classes.noPoint, hasSelected)) })
      );
    }
  }]);
  return ClockPointer;
  ...
  createClass$2(TimePickerWrapper, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          ampm = _props.ampm,
          fadeTimeout = _props.fadeTimeout,
          other = objectWithoutProperties$2(_props, ['value', 'format', 'autoOk', 'onChange', 'utils', 'ampm', 'fadeTimeout']);
  ...
  createClass$2(DateTimePickerWrapper, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          animateYearScrolling = _props.animateYearScrolling,
          fadeTimeout = _props.fadeTimeout,
          other = objectWithoutProperties$2(_props, ['value', 'format', 'autoOk', 'openTo', 'classes', 'minDate', 'maxDate', 'showTabs', 'autoSubmit', 'disablePast', 'disableFuture', 'leftArrowIcon', 'rightArrowIcon', 'dateRangeIcon', 'timeIcon', 'renderDay', 'utils', 'ampm', 'shouldDisableDate', 'animateYearScrolling', 'fadeTimeout']);
...
var MuiPickersUtilsProvider = function (_Component) {
  ...
  function MuiPickersUtilsProvider() {
    ...
    return possibleConstructorReturn$2(this, (MuiPickersUtilsProvider.__proto__ || Object.getPrototypeOf(MuiPickersUtilsProvider)).apply(this, arguments));
  }
